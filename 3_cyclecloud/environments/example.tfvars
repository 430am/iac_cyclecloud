...
CURRENT_IP_ADDRESS = "0.0.0.0/32"

# CycleCloud stage settings
# foundation_state_path = "../1_infrastructure/terraform.tfstate"
# sig_image_version = "latest"
# cyclecloud_vm_size = "Standard_D4ads_v6"
# cyclecloud_subnet_name = "CycleCloud"
# private_endpoints_subnet_name = "PrivateEndpoints"
# anf_subnet_name = "Storage"

# Azure NetApp Files settings
# anf_pool_service_level = "Standard"
# anf_pool_size_tb = 4
# anf_sched_quota_gb = 1024
# anf_share_quota_gb = 1024
